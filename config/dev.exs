...
config :app, AppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "MM9IIH6KexLmjfelIY7MxovEZOpvtmPWSop64Rh9EYloumJjVc6HDlz+y46ROiu5",
  watchers: [
...
config :salad_ui, components_path: Path.join(File.cwd!(), "lib/app_web/components")
